...
export default function MembersClient({ heroes, legacyPieces }: { heroes: VotableItem[]; legacyPieces: VotableItem[] }) {
          ...
          {items.map((item) => {
            ...
            return (
              <div key={item.id} style={{
                ...
                {item.image && (
                  <img src={item.image} alt={item.name} style={{ width: '3rem', height: '3rem', objectFit: 'cover', borderRadius: '4px', flexShrink: 0 }} />
                )}
